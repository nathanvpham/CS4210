...
# SPECIFICATION: praticing perceptron hyperparameters
# FOR: CS 4210- Assignment #4
# TIME SPENT: 11/10/2022
#-----------------------------------------------------------*/
...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
            if a==0 and accuracy > highest_accuracy_perceptron:
               n_val = w
               r_val = b
               highest_accuracy_perceptron = accuracy
               print("Highest Perceptron accuracy so far: " + str(highest_accuracy_perceptron) + ", Parameters: learning rate=" + str(n_val) + ", shuffle=" + str(r_val))
            elif a==1 and accuracy > highest_accuracy_MLP:
               n_val = w
               r_val = b
               highest_accuracy_MLP = accuracy
               print("Highest MLP accuracy so far: " + str(highest_accuracy_MLP) + ", Parameters: learning rate=" + str(n_val) + ", shuffle=" + str(r_val))
